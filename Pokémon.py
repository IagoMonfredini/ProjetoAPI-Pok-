...
#Verifica se o dicionario "pokedex" existe, caso não exista o st.session_state
...
#Imagem da pokébola no menu lateral

st.sidebar.image(
    "https://upload.wikimedia.org/wikipedia/commons/5/53/Pok%C3%A9_Ball_icon.svg", width=175)
menu = st.sidebar.radio("Menu", ["Cadastrar Pokémon", "Listar Pokémon", "Atualizar Pokémon", "Deletar Pokémon"])

#Menu interativo de cadastramento dos pokémons
...
#Aba de listagem dos pokémons cadastrados
...
#Aba de atualizar os dados que o usuario queira mudar
